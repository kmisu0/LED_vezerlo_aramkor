...
#define TCPIP_TCP_KEEP_ALIVE_TIMEOUT		    		5000
#define TCPIP_TCP_CLOSE_WAIT_TIMEOUT		    		200
#define TCPIP_TCP_MAX_RETRIES		            		5
#define TCPIP_TCP_MAX_UNACKED_KEEP_ALIVES			3
...
#define TCPIP_NETWORK_DEFAULT_HOST_NAME 			"PIC32_LED"
#define TCPIP_NETWORK_DEFAULT_MAC_ADDR	 			0
#define TCPIP_NETWORK_DEFAULT_IP_ADDRESS 			"192.168.0.20"
#define TCPIP_NETWORK_DEFAULT_IP_MASK 				"255.255.255.0"
#define TCPIP_NETWORK_DEFAULT_GATEWAY	 			"127.0.0.1"
#define TCPIP_NETWORK_DEFAULT_DNS 				"127.0.0.1"
